...
public class functionHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, DHRS_Corba.function t)
    {
     ...
     */
    public static DHRS_Corba.function extract( org.omg.CORBA.Any a )
    {
        ...
        try
        {
            return DHRS_Corba.functionHelper.narrow( a.extract_Object() );
        }
     ...
     */
    public static DHRS_Corba.function read(org.omg.CORBA.portable.InputStream istream)
    {
        return(DHRS_Corba.function)istream.read_Object(DHRS_Corba._functionStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, DHRS_Corba.function value)
    {
